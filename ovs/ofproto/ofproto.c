...
void abnormal_detect1(struct ofproto *p)
{
    ...
    {  
      ...
      struct ofputil_port_stats ops1 = { .port_no = port1->ofp_port };
      ...
      current_traf1_p2=((float)(now_recorded_n_bytes1_p2-p->last_recorded_n_bytes1_p2))/CYCLE;
      
      fp1=fopen("home/lctuan/result_LoOP/data_recording1_p2.log","a+");
     ...
     {    
      ...
      else 
      {
         ...
         p->loOP_status1 = LoOP_udate(p->state1,p->Data1);
          ...
          fp1= fopen("/home/lctuan/result_LoOP/update1_p1.log","w+");
          fprintf(fp1,"%f\n",p->loOP_status1);
          fclose(fp1);
          }
      }
...
///////////////port2////////////////////////////////////////////
     ...
     {    
        if(p->data_counter1_p2==0 || p->data_counter1_p2 == DATANUM)
          fp1=fopen("/home/lctuan/result_LoOP/training1_p2.log","r");  //read only for read in calculate
        ...
        //     fclose(fp1);
          ...
          fp1=fopen("/home/lctuan/result_LoOP/time1_p2.log","a+");
          fprintf(fp1,"%lu\n",(end1_p2.tv_sec - start1_p2.tv_sec)*1000000+end1_p2.tv_usec-start1_p2.tv_usec);
          fclose(fp1);
          fp1=fopen("/home/lctuan/result_LoOP/nor_training1_p2.log","a+");
          for(int i=0;i<p->data_counter1_p2;i++)
          {
      ...
      else 
      {
         ...
         p->loOP_status1_p2 = LoOP_udate(p->state1_p2,p->Data1_p2);
          ...
          fp1= fopen("/home/lctuan/result_LoOP/update1_p2.log","w+");
          fprintf(fp1,"%f\n",p->loOP_status1_p2);
          fclose(fp1);
          }
      }
      p->last_recorded_n_bytes1_p2=now_recorded_n_bytes1_p2;
...
void abnormal_detect2(struct ofproto *p)
{
    ...
    {  
      ...
      struct ofputil_port_stats ops2_p2; //= { .port_no = port2_p2->ofp_port };
      ...
      current_traf2_p2=((float)(now_recorded_n_bytes2_p2-p->last_recorded_n_bytes2_p2))/CYCLE;
      
      fp2=fopen("home/lctuan/result_LoOP/data_recording2_p2.log","a+");
     ...
     {    
      ...
      else if (p->training2 ==2)
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
          ...
          fp2= fopen("/home/lctuan/result_LoOP/update2_p1.log","w+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
 ...
 /*--------------------port2 ------------------------------------------*/
     ...
     {    
        if(p->data_counter2_p2==0 || p->data_counter2_p2 == DATANUM)
          fp2=fopen("/home/lctuan/result_LoOP/training2_p2.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        //if(fp2==NULL || p->writing2 == 1)
        ...
        { 
          ...
          fp2 = fopen("/home/lctuan/result_LoOP/aver.log","a+");
          ...
          float temp2;
          fp2= fopen("/home/lctuan/result_LoOP/debug2_p2.log","a+");
          for(int i=0;i<p->data_counter2_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp2=fopen("/home/lctuan/result_LoOP/time2_p2.log","a+");
          fprintf(fp2,"%lu\n",(end2_p2.tv_sec - start2_p2.tv_sec)*1000000+end2_p2.tv_usec-start2_p2.tv_usec);
          fclose(fp2);
          fp2=fopen("/home/lctuan/result_LoOP/nor_training2_p2.log","a+");
          for(int i=0;i<p->data_counter2_p2;i++)
          {
      ...
      else if (p->training2_p2 ==2)
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
          ...
          fp2= fopen("/home/lctuan/result_LoOP/update2_p2.log","w+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }

      p->last_recorded_n_bytes2_p2=now_recorded_n_bytes2_p2;
...
void abnormal_detect3(struct ofproto *p)
{
    ...
    {  
      ...
      current_traf3_p2=((float)(now_recorded_n_bytes3_p2-p->last_recorded_n_bytes3_p2))/CYCLE;
      
      fp3=fopen("home/lctuan/result_LoOP/data_recording3_p2.log","a+");
     ...
     {    
      ...
      else if(p->training3 == 3)
      {
         ...
         p->loOP_status3 = LoOP_udate(p->state3,p->Data3);
          ...
          fp3= fopen("/home/lctuan/result_LoOP/update3_p1.log","w+");
          fprintf(fp3,"%f\n",p->loOP_status3);
          fclose(fp3);
          }
      }
...
/*-------------------port2-----------------------*/
     ...
     {    
        if(p->data_counter3_p2==0 || p->data_counter3_p2 == DATANUM)
          fp3=fopen("/home/lctuan/result_LoOP/training3_p2.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        //if(fp3==NULL || p->writing3 == 1)
        ...
        { 
          ...
          float temp3_p2;
          fp3= fopen("/home/lctuan/result_LoOP/debug3_p2.log","a+");
          for(int i=0;i<p->data_counter3_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp3=fopen("/home/lctuan/result_LoOP/time3_p2.log","a+");
          fprintf(fp3,"%lu\n",(end3_p2.tv_sec - start3_p2.tv_sec)*1000000+end3_p2.tv_usec-start3_p2.tv_usec);
          fclose(fp3);
          fp3=fopen("/home/lctuan/result_LoOP/nor_training3_p2.log","a+");
          for(int i=0;i<p->data_counter3_p2;i++)
          {
      ...
      else if(p->training3_p2 == 3)
      {
         ...
         p->loOP_status3_p2 = LoOP_udate(p->state3_p2,p->Data3_p2);
          ...
          fp3= fopen("/home/lctuan/result_LoOP/update3_p2.log","w+");
          fprintf(fp3,"%f\n",p->loOP_status3_p2);
          fclose(fp3);
          }
      }
      p->last_recorded_n_bytes3_p2=now_recorded_n_bytes3_p2;
...
void abnormal_detect4(struct ofproto *p)
{
    ...
    long now_recorded_n_bytes4_p2;
    long now_recorded_n_bytes4_p3;
    ...
    {  
      ...
      current_traf4_p2 = ((float)(now_recorded_n_bytes4_p2 - p->last_recorded_n_bytes4_p2))/CYCLE;

      current_flow4_p3 = ((float)(now_recorded_n_flow4_p3 - p->last_recorded_n_flow4_p3))/CYCLE;
      current_traf4_p3 = ((float)(now_recorded_n_bytes4_p3 - p->last_recorded_n_bytes4_p3))/CYCLE;
      
      fp4=fopen("home/lctuan/result_LoOP/data_recording4.log","a+");
      fprintf(fp4, "%f,%f,",current_flow4,current_traf4);
      fclose(fp4);

      fp4=fopen("home/lctuan/result_LoOP/data_recording4_p2.log","a+");
      fprintf(fp4, "%f,%f,",current_flow4_p2,current_traf4_p2);
      fclose(fp4);

      fp4=fopen("home/lctuan/result_LoOP/data_recording4_p3.log","a+");
     ...
     {    
      ...
      else if (p->training4 == 4)
      {
         ...
         p->loOP_status4 = LoOP_udate(p->state4,p->Data4);
          ...
          fp4= fopen("/home/lctuan/result_LoOP/update4_p1.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4);
          fclose(fp4);
          }
     ...
     {    
        if(p->data_counter4_p2==0 || p->data_counter4_p2 == DATANUM)
          fp4=fopen("/home/lctuan/result_LoOP/training4_p2.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        ...
        { 
          ...
          float temp4_p2;
          fp4= fopen("/home/lctuan/result_LoOP/debug4_p2.log","a+");
          for(int i=0;i<p->data_counter4_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp4=fopen("/home/lctuan/result_LoOP/time4_p2.log","a+");
          fprintf(fp4,"%lu\n",(end4_p2.tv_sec - start4_p2.tv_sec)*1000000+end4_p2.tv_usec-start4_p2.tv_usec);
          fclose(fp4);
          fp4=fopen("/home/lctuan/result_LoOP/nor_training4_p2.log","a+");
          for(int i=0;i<p->data_counter4_p2; i++)
          {
      ...
      else if (p->training4_p2 == 4)
      {
         ...
         p->loOP_status4_p2 = LoOP_udate(p->state4_p2, p->Data4_p2);
          ...
          fp4= fopen("/home/lctuan/result_LoOP/update4_p2.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p2);
          fclose(fp4);
          }
      ...
      p->last_recorded_n_bytes4_p2 = now_recorded_n_bytes4_p2;
     ...
     {    
        if(p->data_counter4_p3==0 || p->data_counter4_p3 == DATANUM)
          fp4=fopen("/home/lctuan/result_LoOP/training4_p3.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        ...
        { 
          ...
          float temp4_p3;
          fp4= fopen("/home/lctuan/result_LoOP/debug4_p3.log","a+");
          for(int i=0;i<p->data_counter4_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp4=fopen("/home/lctuan/result_LoOP/time4_p3.log","a+");
          fprintf(fp4,"%lu\n",(end4_p3.tv_sec - start4_p3.tv_sec)*1000000+end4_p3.tv_usec-start4_p3.tv_usec);
          fclose(fp4);
          fp4=fopen("/home/lctuan/result_LoOP/nor_training4_p3.log","a+");
          for(int i=0;i<p->data_counter4_p3; i++)
          {
      ...
      else if (p->training4_p3 == 4)
      {
         ...
         p->loOP_status4_p3 = LoOP_udate(p->state4_p3, p->Data4_p3);
          ...
          fp4= fopen("/home/lctuan/result_LoOP/update4_p3.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p3);
          fclose(fp4);
          }
      ...
      p->last_recorded_n_bytes4_p3 = now_recorded_n_bytes4_p3;
...
void abnormal_detect5(struct ofproto *p)
{
    ...
    {  
      ...
      current_traf5_p2 = ((float)(now_recorded_n_bytes5_p2 - p->last_recorded_n_bytes5_p2))/CYCLE;
      
      fp5=fopen("home/lctuan/result_LoOP/data_recording5.log","a+");
      fprintf(fp5, "%f,%f,",current_flow5,current_traf5);
      fclose(fp5);

      fp5=fopen("home/lctuan/result_LoOP/data_recording5_p2.log","a+");
     ...
     {    
      ...
      else if (p->training5 == 5)
      {
         ...
         p->loOP_status5 = LoOP_udate(p->state5,p->Data5);
          ...
          fp5= fopen("/home/lctuan/result_LoOP/update5_p1.log","w+");
          fprintf(fp5,"%f\n",p->loOP_status5);
          fclose(fp5);
          }
      }
     ...
     {    
        if(p->data_counter5_p2==0 || p->data_counter5_p2 == DATANUM)
          fp5=fopen("/home/lctuan/result_LoOP/training5_p2.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        ...
        { 
          ...
          float temp5_p2;
          fp5= fopen("/home/lctuan/result_LoOP/debug5_p2.log","a+");
          for(int i=0;i<p->data_counter5_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp5=fopen("/home/lctuan/result_LoOP/time5_p2.log","a+");
          fprintf(fp5,"%lu\n",(end5_p2.tv_sec - start5_p2.tv_sec)*1000000+end5_p2.tv_usec-start5_p2.tv_usec);
          fclose(fp5);
          fp5=fopen("/home/lctuan/result_LoOP/nor_training5_p2.log","a+");
          for(int i=0;i<p->data_counter5_p2;i++)
          {
      ...
      p->last_recorded_n_bytes5_p2=now_recorded_n_bytes5_p2;
...
void abnormal_detect6(struct ofproto *p)
{
    ...
    long now_recorded_n_bytes6_p2;
    long now_recorded_n_bytes6_p3;
    ...
    {  
      ...
      current_traf6_p2 = ((float)(now_recorded_n_bytes6_p2 - p->last_recorded_n_bytes6_p2))/CYCLE;

      current_flow6_p3 = ((float)(now_recorded_n_flow6_p3 - p->last_recorded_n_flow6_p3))/CYCLE;
      current_traf6_p3 = ((float)(now_recorded_n_bytes6_p3 - p->last_recorded_n_bytes6_p3))/CYCLE;
      
      fp6=fopen("home/lctuan/result_LoOP/data_recording6.log","a+");
      fprintf(fp6, "%f,%f,",current_flow6,current_traf6);
      fclose(fp6);

      fp6=fopen("home/lctuan/result_LoOP/data_recording6_p2.log","a+");
      fprintf(fp6, "%f,%f,",current_flow6_p2, current_traf6_p2);
      fclose(fp6);

      fp6=fopen("home/lctuan/result_LoOP/data_recording6_p3.log","a+");
     ...
     {    
      ...
      else if (p->training6 == 6)
      {
         ...
         p->loOP_status6 = LoOP_udate(p->state6,p->Data6);
          ...
          fp6= fopen("/home/lctuan/result_LoOP/update6_p1.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6);
          fclose(fp6);
          }
     ...
     {    
        if(p->data_counter6_p2==0 || p->data_counter6_p2 == DATANUM)
          fp6=fopen("/home/lctuan/result_LoOP/training6_p2.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        ...
        { 
          ...
          float temp6_p2;
          fp6= fopen("/home/lctuan/result_LoOP/debug6_p2.log","a+");
          for(int i=0;i<p->data_counter6_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp6=fopen("/home/lctuan/result_LoOP/time6_p2.log","a+");
          fprintf(fp6,"%lu\n",(end6_p2.tv_sec - start6_p2.tv_sec)*1000000+end6_p2.tv_usec-start6_p2.tv_usec);
          fclose(fp6);
          fp6=fopen("/home/lctuan/result_LoOP/nor_training6_p2.log","a+");
          for(int i=0;i<p->data_counter6_p2;i++)
          {
      ...
      else if (p->training6_p2 == 6)
      {
         ...
         p->loOP_status6_p2 = LoOP_udate(p->state6_p2,p->Data6_p2);
          ...
          fp6= fopen("/home/lctuan/result_LoOP/update6_p2.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6_p2);
          fclose(fp6);
          }
      ...
      p->last_recorded_n_bytes6_p2=now_recorded_n_bytes6_p2;
     ...
     {    
        if(p->data_counter6_p3==0 || p->data_counter6_p3 == DATANUM)
          fp6=fopen("/home/lctuan/result_LoOP/training6_p3.log","r");
        /*check training file exist or not .if not exist or not enough data, recording.
          if exists , move to calculating*/
        ...
        { 
          ...
          float temp6_p3;
          fp6= fopen("/home/lctuan/result_LoOP/debug6_p3.log","a+");
          for(int i=0;i<p->data_counter6_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
          ...
          fp6=fopen("/home/lctuan/result_LoOP/time6_p3.log","a+");
          fprintf(fp6,"%lu\n",(end6_p3.tv_sec - start6_p3.tv_sec)*1000000+end6_p3.tv_usec-start6_p3.tv_usec);
          fclose(fp6);
          fp6=fopen("/home/lctuan/result_LoOP/nor_training6_p3.log","a+");
          for(int i=0;i<p->data_counter6_p3;i++)
          {
      ...
      else if (p->training6_p3 == 6)
      {
         ...
         p->loOP_status6_p3 = LoOP_udate(p->state6_p3,p->Data6_p3);
          ...
          fp6= fopen("/home/lctuan/result_LoOP/update_p3.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6_p3);
          fclose(fp6);
          }
      ...
      p->last_recorded_n_bytes6_p3=now_recorded_n_bytes6_p3;
